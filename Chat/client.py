...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='UDP Chat Client - Built over UDP Echo Client',
    ...
    parser.add_argument('-p', '--port', type=int, metavar="PORT_NUMBER",
                        help='UDP Chat Server Port Number to connect to', default=7776)
    parser.add_argument('-s', '--size', type=int, help='UDP Chat Packet Size in Bytes', default=1024,
                        metavar="PACKET_SIZE")
